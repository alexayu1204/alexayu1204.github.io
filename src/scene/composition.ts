...
export const FRAMES: FrameDef[] = [
  ...
  },
  {
    ...
    shape: 'oval',
    style: 'gilt',
    art: 'woman.svg', // after Girl with a Mandolin (1910) — a reader instead
  ...
  },
  {
    ...
    style: 'ebony',
    art: 'p-contact.webp',
    wide: { x: 1725, y: 366, w: 200, h: 147, rot: -0.3 },
    narrow: { x: 856, y: 1131, w: 190, h: 140, rot: -0.3 },
    z: 5,
  },
  ...
  /* ---- orbiters: density, not navigation. No title, no pointer, no destination. ---- */
  {
    ...
    shape: 'oval',
    style: 'brass',
    art: 'dove.svg', // after La Colombe (1949)
  ...
  },
  {
    ...
    shape: 'rect',
    style: 'gilt',
    art: 'profiles.svg', // the double profile
